...
const AdminShipping = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        await axios.put(
          `${API_URL}/api/shipping/${editingId}`,
          formData,
          { headers: { Authorization: `Bearer ${token}` } }
        );
  ...
  if (loading) return <div className="admin-loading">Loading shipping rules...</div>;
              ...
              shippingRules.map((rule) => (
                <tr key={rule._id}>
                  ...
                  <td>
                    ...
                    <button className="btn-delete" onClick={() => handleDelete(rule._id)}>
                      Delete
                    </button>
                  </td>
                </tr>
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, freeShippingThreshold: parseFloat(e.target.value) })
                    }
                    min="0"
                    step="0.01"
