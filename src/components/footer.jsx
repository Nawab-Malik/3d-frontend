          ...
          <div className="row gx-5">
            ...
            <div className="col-md-4 mb-4 mb-md-0">
              ...
              <ul className="list-unstyled">
                <li className="mb-2"><span style={{ opacity: 0.8 }}>Terms and Conditions</span></li>
                <li className="mb-2"><span style={{ opacity: 0.8 }}>Privacy Policy</span></li>
                <li><Link to="/contact" className="text-white text-decoration-none">Stay in touch</Link></li>
              </ul>
            </div>
            ...
            <div className="col-md-4 mb-4 mb-md-0 d-flex flex-column">
              ...
              <Link to="/second" className="mb-2 text-white text-decoration-none">Quote</Link>
              <Link to="/products" className="mb-2 text-white text-decoration-none">Store</Link>
              <Link to="/delivery" className="mb-2 text-white text-decoration-none">Delivery</Link>
            ...
            <div className="col-md-4 d-flex flex-column">
              ...
              <div className="d-flex gap-3 mt-auto">
                <a href="https://wa.me/15551234567" target="_blank" rel="noopener noreferrer" className="text-white fs-4"><FaWhatsapp /></a>
