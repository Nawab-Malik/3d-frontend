    ...
    <>
      ...
      <section style={{ background: "#f9f9fb" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "60px 20px" }}>
          ...
          {loadingFeedback && (
            <div style={{ color: "#6b6b6b" }}>Loading feedback...</div>
          )}
          {!!feedbackError && (
            <div style={{ color: "#b00020" }}>{feedbackError}</div>
          )}
          {!loadingFeedback &&
            !feedbackError &&
            (feedbacks.length === 0 ? (
...
// Find and replace all $ with £ for any featured products or pricing sections
